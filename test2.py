...
class InternetSpeedTwitter:
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(5)
        first_name = self.driver.find_element(By.CSS_SELECTOR, 'input[autocomplete="username"]')
        first_name.send_keys(ID)
        ...
        self.password.send_keys(f"Hey Internet Providers")
...
provider = InternetSpeedTwitter()
provider.tweet_at_provider()